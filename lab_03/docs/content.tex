...
\imgw{150mm}{1}{График зависимости температуры $T(x)$ от координаты $x$ при заданных в теоретической части параметрах.}
...
\imgw{150mm}{2}{График при $F_0 = 500$ и $n_p = 7$.}

При увеличении $F_0$ кривые становятся более выпуклые.

\clearpage

\subsection{График зависимости $T(x)$ при $F_{0} = -10 \frac{\text{Вт}}{\text{см}^2}$}

\imgw{150mm}{3}{График зависимости $T(x)$ при $F_{0} = -10 \frac{\text{Вт}}{\text{см}^2}$}

\clearpage

\subsection{График зависимости $T(x)$ при увеличенных значениях $\alpha$ (например, в 3 раза). Сравнить с п. 2.}

\imgw{150mm}{4}{График зависимости $T(x)$ (оранжевая кривая -- при увеличенном в 3 раза параметре $\alpha$)}

\clearpage

Для параметров из п.2:

\imgw{150mm}{5}{График зависимости $T(x)$  (оранжевая кривая -- при увеличенном в 3 раза параметре $\alpha$)}

\clearpage

\subsection{График зависимости $T(x)$ при $F_{0} = 0$}

\imgw{150mm}{6}{График зависимости $T(x)$ при $F_{0} = 0$}
